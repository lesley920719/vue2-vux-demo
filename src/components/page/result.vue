<template>
  <div class="sucess">
    ...
    <div class="tips"
      ...
      <p class="text">实际办理结果以官方通知为准。如有疑问请咨询官方客服</p>
      <p class="text">官方客服：<a :href="`tel: ${serviece}`"
           class="tel">{{serviece}}</a></p>
    </div>
    <div class="adver">
      <swiper :auto="true"
              :loop="true"
              :aspect-ratio="320/798"
              v-if="clientCommonData.environment != 0">
...
.tips {
  margin-top: 0.1rem;
  padding: 0.23rem @page-space 0.27rem;
  background: #fff;
  .title {
    font-size: 0.28rem;
    color: #333333;
