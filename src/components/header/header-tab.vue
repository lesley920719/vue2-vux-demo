<template>
  ...
  <div class="header-store"
       v-if="clientCommonData.origin == '3'">
    <div class="avator"
         @click="goHome">
      <img :src="clientShopData.logo || require('@/assets/images/default_avator@2x.png')"
           alt=""
           class="avator-img">
    </div>
    <div class="info">
    ...
    <a :href="`tel:${clientShopData.phoneNumber}`"
       class="take-phone"></a>
  </div>
...
.header-tab {
  ...
  /* background: #F9F9F9; */
  background: #fff;
  box-shadow: inset 0 -1px 0 0 rgba(219, 219, 219, 0.5);
  position: relative;
  &.iphone {
    height: 1.28rem;
